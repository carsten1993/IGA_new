...
namespace IGA.Components._07._Test
{
    public class Display_Geometry : GH_Component
    {

        public Display_Geometry()
          : base("Display Geometry", "display_geometry",
              "Display a patch with a given grid",
              "IGA", "06. Tools")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (btm)
            {
                lines = GetLines(patch, step);
            }
            else
            {
                lines = GetGridLines(patch, grid, step);
            }
            //////////////////////////////////////////////// OUTPUT ////////////////////////////////////////////////
            ////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        List<Line> GetLines(Patch patch, double step)
        {
            List<Line> lines = new List<Line>();
        ...
        List<Line> GetGridLines(Patch patch, List<int> grid, double step)
        {
            List<Line> lines = new List<Line>();
            List<Line> csiLines = new List<Line>();
            List<Line> etaLines = new List<Line>();
        ...
        {
            get { return new Guid("d73dd825-4776-48db-b9a4-b88f05bbfd9c"); }
        }
    }
}